...
@app.on_message(filters.command("ycast") & filters.user(BOT_OWNER) & filters.reply)
@app.on_message(filters.regex(r"^(?i)Yumeko Bcast$") & filters.user(BOT_OWNER) & filters.reply)
